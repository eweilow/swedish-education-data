...
module.exports = function parsePrograms(files, subjects, courses) {
  ...
  const customProgramUrls = {
    ...
    "FX": "http://www.skolverket.se/laroplaner-amnen-och-kurser/gymnasieutbildning/gymnasieskola/programstruktur-och-examensmal/flygteknikutbildningen",
    ...
    "MX": "http://www.skolverket.se/laroplaner-amnen-och-kurser/gymnasieutbildning/gymnasieskola/programstruktur-och-examensmal/marinteknikutbildningen",
    ...
    "UX": "http://www.skolverket.se/laroplaner-amnen-och-kurser/gymnasieutbildning/gymnasieskola/programstruktur-och-examensmal/samiska-naringar",
    "SX": "http://www.skolverket.se/laroplaner-amnen-och-kurser/gymnasieutbildning/gymnasieskola/programstruktur-och-examensmal/sjofartsutbildningen",
    ...
    "TX": "http://www.skolverket.se/laroplaner-amnen-och-kurser/gymnasieutbildning/gymnasieskola/programstruktur-och-examensmal/tagteknikutbildningen",
    ...
    "YX": "http://www.skolverket.se/skolformer/gymnasieutbildning/gymnasieskola/program-och-utbildningar/riksrekryterande-utbildningar/yrkesdansarutbildningen"
  };
  ...
  return Promise.all(xmlParsePromises)
    .then((xmlFiles) => {
      ...
      for(let xml of xmlFiles) {
        ...
        assert.oneOf(xmlProgram.purpose.orientation.title, ["Profiler", "Inriktningar"], context);
